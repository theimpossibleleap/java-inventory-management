...
//        product.getParts().addAll(assparts);
    ...
    public String buyProduct(@RequestParam("productID") int theId, Model theModel) {
        ...
        if (product.getInv() <= 0) {
            theModel.addAttribute("errorMessage", "Product " + product.getName() + " is out of stock.");
        ...
        theModel.addAttribute("successMessage", "Product " + product.getName() + " was successfully purchased.");
