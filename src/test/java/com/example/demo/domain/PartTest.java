...
class PartTest {
    ...
    // Added test for checking Set / Get Minimum Inventory
    @Test
    void testMinInv() {
        int minInv = 15;
        partIn.setMinPartInv(minInv);
        assertEquals(minInv,partIn.getMinPartInv());

        partOut.setMinPartInv(minInv);
        assertEquals(minInv,partOut.getMinPartInv());
    }

    // Added test for checking Set / Get Maximum Inventory
    @Test
    void testMaxInv() {
        int maxInv = 150;
        partIn.setMaxPartInv(maxInv);
        assertEquals(maxInv,partIn.getMaxPartInv());

        partOut.setMaxPartInv(maxInv);
        assertEquals(maxInv,partOut.getMaxPartInv());
    }
}